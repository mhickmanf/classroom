	...
	*/
	public static function get_registered_modules() {
		return [
			...
			'Dual Color Heading' => ['dual-color-heading', 'https://royal-elementor-addons.com/elementor-dual-color-heading-widget/?ref=rea-plugin-backend-elements-widget-prev', '', ''],
			'Advanced Text' => ['advanced-text', 'https://royal-elementor-addons.com/elementor-advanced-text-widget/', '', ''],
			'Flip Carousel' => ['flip-carousel', 'https://royal-elementor-addons.com/elementor-flip-carousel-widget/?ref=rea-plugin-backend-elements-widget-prev', '', ''],
			...
			'Feature List' => ['feature-list', 'https://royal-elementor-addons.com/elementor-feature-list-widget/?ref=rea-plugin-backend-elements-widget-prev', '', ''],
			...
			'Reading Progress Bar' => ['reading-progress-bar', '', '', 'new'],
